...
"# Crypto-tracker"  git init git add README.md git commit -m "first commit" git remote add origin git@github.com:kluk12/Crypto-tracker.git git push -u origin master
"# Crypto-tracker" 
